...
""",
    ...
    http_archive(
        ...
        url = "https://ftp.mozilla.org/pub/firefox/releases/125.0b8/linux-x86_64/en-US/firefox-125.0b8.tar.bz2",
        sha256 = "157913784ad9ac96903c1b15dc0592ac7853e56a5cdb3793b90cd3acf3095786",
        build_file_content = """
filegroup(
    name = "files",
    srcs = glob(["**/*"]),
...
""",
    ...
    dmg_archive(
        ...
        url = "https://ftp.mozilla.org/pub/firefox/releases/125.0b8/mac/en-US/Firefox%20125.0b8.dmg",
        sha256 = "2a7cd20e2e1cdcf0148e3a5c19181565ec7b07f45bfdcb3342ab37d061f4616e",
        build_file_content = "exports_files([\"Firefox.app\"])",
    )
